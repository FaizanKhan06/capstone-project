...
function CommunityView({ handleOpenSnackbar }) {
  ...
  function handleMakeRequest() {
    ...
    navigate(getAllUrls(retrieveUser().roleId).makeRequest, {
      state: {
        communityId: communityDetails.communityId,
        email: retrieveUser().email,
        maxAmount: communityDetails.currentAmount,
      },
    });
  }
  function handleMakeContribution() {
    ...
    navigate(getAllUrls(retrieveUser().roleId).makeContribution, {
      state: {
